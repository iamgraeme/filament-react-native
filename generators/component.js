exports.gen = function (Filament, flags, arg) {
  ...
  Filament.askList('Do you want this to be a functional component?', ['Yes', 'No'], (res) => {
  ...
  Filament.createFile('app/components/' + arg + '/index.js', 'screenAndComponent/index.'+ isFunctional + '.js', {
    name: arg,
    path: 'components'
  });
